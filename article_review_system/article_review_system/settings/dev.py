"""
Django settings for article_review_system project.
...
ROOT_URLCONF = 'article_review_system.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            # 补充Jinja2模板引擎环境
            'environment': 'article_review_system.utils.jinja2_env.jinja2_environment',
        },
    },
]

WSGI_APPLICATION = 'article_review_system.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), 'logs/article_review_system.log'),  # 日志文件的位置
